...
@Component({
  selector: 'app-peliculaadmin-modal',
  templateUrl: './peliculaadmin-modal.component.html',
  styleUrls: ['./peliculaadmin-modal.component.css']
})
export class PeliculaadminModalComponent implements OnInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<PeliculaadminModalComponent>,
