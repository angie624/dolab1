...
import { PeliculaadminModalComponent } from './peliculaadmin-modal/peliculaadmin-modal.component';

@Component({
  selector: 'app-peliculaadmin',
  templateUrl: './peliculaadmin.component.html',
  styleUrls: ['./peliculaadmin.component.css']
})
export class PeliculaadminComponent implements OnInit {

  displayedColumns = [ 'titulo', 'categoria', 'descripcion', 'fecha', 'director','actor', 'editar-eliminar'];
  ...
  openModal(pelicula?: Pelicula){
    ...
    this.dialog.open(PeliculaadminModalComponent,{
      width:'260px',
      data: peli
    })
  }
