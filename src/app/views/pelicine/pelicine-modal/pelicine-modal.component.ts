...
@Component({
  selector: 'app-pelicine-modal',
  templateUrl: './pelicine-modal.component.html',
  styles: [
  ]
})
export class  PelicineModalComponent implements OnInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<PelicineModalComponent>,
