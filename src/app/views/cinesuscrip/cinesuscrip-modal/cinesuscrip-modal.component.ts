...
@Component({
  selector: 'app-cinesuscrip-modal',
  templateUrl: './cinesuscrip-modal.component.html',
  styleUrls: ['./cinesuscrip-modal.component.css']
})
export class CinesuscripModalComponent implements OnInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<CinesuscripModalComponent>,
  ...
  ngOnInit(): void {
    ...
    this.pelicula.estado=this.data.estado;
